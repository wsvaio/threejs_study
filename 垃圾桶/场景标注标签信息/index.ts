...
use(async () => {
	...
	const dom = domParser.parseFromString(
		`
	<div id="tag" style="backface-visibility: hidden; display: none; width: max-content; background: pink; transition: all .3s;">
		<h1>那些年很冒险的梦</h1>
	</div>
	`,
		"text/html"
	...
	const tag = new CSS3DSprite(dom.getElementById("tag"));
	// scene.add(tag);
